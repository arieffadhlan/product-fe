    ...
    <div className="min-h-screen flex flex-col justify-center items-center">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-1 max-w-[570px] mt-2 mb-5">
          ...
          <p className="font-[400] text-[16px] text-[#595959]">We are sorry, you don't have permission to access the requested page. If you believe this is a mistake, please make sure you're using the correct account.</p>
        </div>
