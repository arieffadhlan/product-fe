...
const BreadcrumbItem = ({ className, ...props }: React.ComponentProps<"li">) => {
  return <li data-slot="breadcrumb-item" className={cn("flex flex-wrap items-center gap-1", className)} {...props} />;
};
...
const BreadcrumbPage = ({ className, ...props }: React.ComponentProps<"span">) => {
  return <span data-slot="breadcrumb-page" className={cn("leading-[1]", className)} {...props} />;
};

const BreadcrumbMore = ({ className, ...props }: React.ComponentProps<"span">) => {
  return (
    <span data-slot="breadcrumb-more" className={cn("flex size-9 items-center justify-center", className)} {...props}>
...
const BreadcrumbSeparator = ({ className, children, ...props }: React.ComponentProps<"li">) => {
  return (
    <li data-slot="breadcrumb-icon" className={cn("[&>svg]:size-4", className)} {...props}>
